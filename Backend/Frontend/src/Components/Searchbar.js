...
export default function Searchbar() {
  ...
  /* Defining the data for the dropdown menu. */
      ...
      <Navbar isBordered variant="sticky">
        <Navbar.Brand css={{ mr: "$4" }}>
          ...
          <p className="navbar-brand pt-0 d-none d-sm-block">
            ...
            <img
              ...
              width="75"
              height="90"
              className="d-inline-block align-text-top logoofwebsite"
            />
            {/* </motion.div> */}
          </p>
        ...
        <Navbar.Content variant="underline-rounded">
          ...
          <Dropdown isBordered>
            ...
            >
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid  fa-utensils fs-4 px-2"
                    style={{ color: "#dc3545" }}
                  ></i>
                }
                command={
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-bowl-food fs-4 px-2"
                    style={{ color: "purple" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-sharp fa-solid fa-cloud-meatball fs-4 px-2 text-info"></i>
                }
              >
                <div
                  onClick={() => {
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-wheat-awn fs-4 px-2 text-success"></i>
                }
              >
                <div
                  onClick={() => {
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-mug-saucer fs-4 px-2 text-primary"></i>
                }
              >
                <div
                  onClick={() => {
          ...
          <Dropdown isBordered>
            ...
            >
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-bread-slice text-success fs-4"></i>
                }
              >
                <div
                  onClick={() => {
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-bowl-food text-danger fs-4"></i>
                }
              >
                <div
                  onClick={() => {
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-sharp fa-solid fa-sink text-primay fs-4"></i>
                }
              >
                {" "}
                <div
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-ice-cream fs-4"
                    style={{ color: "purple" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-wine-glass-empty fs-4"
                    style={{ color: "Violet" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-brands fa-discourse fs-4"
                    style={{ color: "indigo" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-bacon fs-4"
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-mortar-pestle fs-4"
                    style={{ color: "brown" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-sharp fa-solid fa-lemon text-info fs-4"></i>
                }
              >
                {" "}
                <div
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-hotdog fs-4"
                    style={{ color: "purple" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-pump-soap fs-4"
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-hourglass-start fs-4"
          ...
          <Dropdown isBordered>
            ...
            >
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-scale-balanced text-primary fs-4"></i>
                }
              >
                {" "}
                <div
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-tower-observation text-success fs-4"></i>
                }
              >
                <div
                  onClick={() => {
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-bowl-food fs-4"
                    style={{ color: "purple" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-fan fs-4"
                    style={{ color: "brown" }}
                  ></i>
                }
              >
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-prescription-bottle text-info fs-4"></i>
                }
              >
                <div
                  onClick={() => {
          ...
          <Dropdown isBordered>
            ...
            >
              <Dropdown.Item
                ...
                textColor="success"
                icon={
                  <i className="fa-solid fa-champagne-glasses text-success"></i>
                }
                showFullDescription
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Alcohol-Free" } });
                  }}
                >
                  Alcohol-Free
                </div>
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Egg-Free" } });
                  }}
                >
                  Egg-Free
                </div>
              ...
              <Dropdown.Item
                ...
                showFullDescription
                icon={
                  <i className="fa-solid text-primary fs-4 fa-wheat-awn-circle-exclamation"></i>
                }
                description="Enjoy the delectable flavors of our gluten-free recipe, without compromising on taste or texture."
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Gluten-Free" } });
                  }}
                >
                  Gluten-Free
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fs-4 fa-solar-panel"
                    style={{ color: "brown" }}
                  ></i>
                }
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Kidney-Friendly" } });
                  }}
                >
                  Kidney-Friendly
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fs-4 fa-fan"
                    style={{ color: "purple" }}
                  ></i>
                }
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Low-Fat-Abs" } });
                  }}
                >
                  Low-Fat-Abs
                </div>
              ...
              <Dropdown.Item
                ...
                showFullDescription
                icon={
                  <i className="fa-solid fs-4 fa-cubes-stacked text-info"></i>
                }
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Low-sugar" } });
                  }}
                >
                  Low-Sugar
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-brands fs-4 fa-mastodon"
                    style={{ color: "orange" }}
                  ></i>
                }
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Mustard-Free" } });
                  }}
                >
                  Mustard-Free
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fs-4 fa-bottle-droplet"
                    style={{ color: "#b71c1c" }}
                  ></i>
                }
                showFullDescription
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "No-Oil-Added" } });
                  }}
                >
                  No-Oil-Added
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fs-4 fa-drumstick-bite"
                    style={{ color: "darkred" }}
                  ></i>
                }
                showFullDescription
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Red-Meat-Free" } });
                  }}
                >
                  Red-Meat-Free
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fs-4 fa-carrot"
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Vegan" } });
                  }}
                >
                  Vegan
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fs-4 fa-plant-wilt"
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/health", { state: { type: "Vegetarian" } });
                  }}
                >
                  Vegetarian
                </div>
          ...
          <Dropdown isBordered>
            ...
            >
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-indian-rupee-sign  fs-4 px-2"></i>
                }
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "indian" } });
                  }}
                >
                  Indian
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-dollar-sign fs-4 px-2 text-danger"></i>
                }
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "american" } });
                  }}
                >
                  American
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-solid fa-sterling-sign fs-4 px-2 text-primary"></i>
                }
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "british" } });
                  }}
                >
                  British
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i className="fa-brands fa-yandex fs-4 px-2 text-info"></i>
                }
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "chinese" } });
                  }}
                >
                  Chinese
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-euro-sign fs-4 px-2"
                    style={{ color: "purple" }}
                  ></i>
                }
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "italian" } });
                  }}
                >
                  Italian
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-yen-sign fs-4 px-2"
                    style={{ color: "brown" }}
                  ></i>
                }
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "japnese" } });
                  }}
                >
                  Japnese
                </div>
              ...
              <Dropdown.Item
                ...
                icon={
                  <i
                    className="fa-solid fa-peso-sign fs-4 px-2"
                    style={{ color: "#00695c" }}
                  ></i>
                }
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "mexican" } });
                  }}
                >
                  Mexican
                </div>
              ...
              >
                <div
                  onClick={() => {
                    Navigate("/cuisineType", { state: { type: "french" } });
                  }}
                >
                  French
                </div>
                ...
                <Dropdown isBordered>
                  ...
                  >
                    <Dropdown.Item
                      ...
                      textColor="success"
                      icon={
                        <i className="fa-sharp fa-solid fa-database fs-4 px-2 text-dark"></i>
                      }
                    >
                      <div
                        onClick={() => {
                          Navigate("/Admin", {
                            state: { adminActivePageNumber: 0 },
                          });
                          Admingetallstaticaldata();
                        }}
                      >
                    ...
                    <Dropdown.Item
                      ...
                      textColor="primary"
                      icon={
                        <i className="fa-solid fa-user fs-4 px-2 text-primary"></i>
                      }
                    >
                      <div
                        onClick={() => {
                          Navigate("/Admin", {
                            state: { adminActivePageNumber: 1 },
                          });
                          AdminGetAllUser();
                        }}
                      >
                    ...
                    <Dropdown.Item
                      ...
                      icon={
                        <i className="fa-solid fa-user-pen fs-4 px-2 text-info"></i>
                      }
                    >
                      <div
                        onClick={() => {
                          Navigate("/Admin", {
                            state: { adminActivePageNumber: 2 },
                          });
                          AdminGetAllUserByDate();
                        }}
                      >
                    ...
                    <Dropdown.Item
                      ...
                      icon={
                        <i
                          className="fa-solid fa-file-pen fs-4 px-2"
                          style={{ color: "brown" }}
                        ></i>
                      }
                    >
                    ...
                    <Dropdown.Item
                      ...
                      icon={
                        <i
                          className="fa-solid fa-message fs-4 px-2"
                          style={{ color: "#00695c" }}
                        ></i>
                      }
                    >
                    ...
                    <Dropdown.Item
                      ...
                      icon={
                        <i
                          className="fa-solid fa-plus fs-4 px-2"
                          style={{ color: "#212121" }}
                        ></i>
                      }
                    >
          ...
          <form className="d-flex text-white ">
            <input
              className="form-control me-2 text-white  rounded-3"
        ...
        <Navbar.Collapse>
          ...
          <Collapse.Group divider={false}>
            <Collapse title="Home" style={{ cursor: "pointer" }}>
              ...
              localStorage.getItem("auth-token")
                ? userData?.user?.email ===
                    process.env.REACT_APP_Admin_Email_id && (
                    <Navbar.CollapseItem
                      key="ADMIN"
                      onClick={() => {
                        Navigate("/Admin", {
              ...
              {collapsemealItems.map((item) => (
                <Navbar.CollapseItem key={item.name}>
                  <div
                    ...
                    onClick={() => {
                      Navigate(item.path, { state: { type: item.type } });
                    }}
                  >
                    {item.name}
                  </div>
      ...
      >
        ...
        <Modal.Body className="searchmodal">
          <div className="input-group input-group-lg transformingup mb-3">
            <input
              type="text"
              className="form-control modalsearch fw-bold"
              id="button-addon1x"
              placeholder="Enter the Recipe Name"
              aria-label="Example text with button addon"
              onChange={(e) => {
                NameRecipe(`/${e.target.value}`);
              }}
            ...
            <button
              ...
              onClick={(e) => {
                NameRecipe(
                  `/${document.getElementById("button-addon1x")?.value}`
                );
              }}
            >
          ...
          <div>
            ...
            {!searchRecipe ? (
              ...
              <ul className="searchlistbox" id="docsearch-list">
                {" "}
                <div className="listcombo">
                  {!namerecipeloading &&
                    searchRecipe.recipe &&
                          ...
                          <div
                            onClick={() => {
                              ...
                              Navigate("/SearchResult", {
                                state: {
                                  search_result_reicpe: element.label.substring(
                                    0,
                                    20
                                  ),
                                },
                            ...
                            className="DocSearch-Hitslink  transformingup"
                          >
                            <li className="DocSearch-Hits  fw-bold">
                              {" "}
                              <i className="fa-solid me-2 fa-bars"></i>
                              {element.label}
                            </li>
                          </div>
                        </>
